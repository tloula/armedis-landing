                    ...
                    <div className="mt-6">
                        ...
                        <ul className="list-disc pl-6 mt-4">
                            <li>
                                ...
                                <a
                                    href="https://checkinmore.com"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-[var(--link-text)] hover:text-[var(--link-hover)]"
                                >
                                    https://checkinmore.com
                                </a>
                                , or any website of ours that links to this Privacy Notice
                            </li>
                            <li>
                                Download and use our mobile application (CheckIn More),
                                or any other application of ours that links to this Privacy Notice
                            </li>
                            <li>
                                Use CheckIn More. A mobile application for virtual wellness checks.
                            </li>
                            <li>
                        ...
                        <p className="mt-6">
                            ...
                            <a
                                href="mailto:support@hydroxygenlabs.com"
                                className="text-[var(--link-text)] hover:text-[var(--link-hover)]"
                            >
                        ...
                        <div className="mt-8">
                            <p className="italic font-semibold">
                                ...
                                <a href="#toc" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                    table of contents
                                </a>{" "}
                            ...
                            <div className="space-y-6 mt-6">
                                <div>
                                    <p>
                                        ...
                                        <a href="#personalinfo" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                ...
                                <div>
                                    <p>
                                        ...
                                        <a href="#infouse" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                ...
                                <div>
                                    <p>
                                        <strong>In what situations and with which parties do we share personal information?</strong> We may share information in specific situations and with specific categories of third parties. Learn more about{" "}
                                        <a href="#whoshare" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                ...
                                <div>
                                    <p>
                                        ...
                                        <a href="#infosafe" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                ...
                                <div>
                                    <p>
                                        ...
                                        <a href="#privacyrights" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                            your privacy rights
                                        </a>.
                                    </p>
                                </div>
                                ...
                                <div>
                                    <p>
                                        ...
                                        <a href="https://checkinmore.com/data-request" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                            checkinmore.com/data-request
                        ...
                        <div className="mt-12" id="toc">
                            ...
                            <div className="space-y-3">
                                <div>
                                    <a href="#infocollect" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                ...
                                <div>
                                    <a href="#legalbases" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                ...
                                <div>
                                    <a href="#cookies" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                ...
                                <div>
                                    <a href="#intltransfers" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                        7. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?
                                    </a>
                                </div>

                                <div>
                                    <a href="#inforetain" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                ...
                                <div>
                                    <a href="#infominors" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                ...
                                <div>
                                    <a href="#DNT" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                ...
                                <div>
                                    <a href="#policyupdates" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                ...
                                <div>
                                    <a href="#request" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                        ...
                        <div className="mt-12" id="infocollect">
                            ...
                            <div id="personalinfo">
                                ...
                                <div className="mb-6">
                                    <strong>Payment Data.</strong> We may collect data necessary to process your payment if you choose to make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is handled and stored by Google Play, App Store, and RevenueCat. You may find their privacy notice link(s) here:{" "}
                                    <a href="https://play.google.com/intl/en_en/about/play-terms/" target="_blank" rel="noopener noreferrer" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                        https://play.google.com/intl/en_en/about/play-terms/
                                    </a>
                                    ,{" "}
                                    <a href="https://www.apple.com/legal/privacy/data/en/app-store/" target="_blank" rel="noopener noreferrer" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                        https://www.apple.com/legal/privacy/data/en/app-store/
                                    </a>
                                    , and{" "}
                                    <a href="https://www.revenuecat.com/privacy/" target="_blank" rel="noopener noreferrer" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                ...
                                <p className="mb-4">
                                    ...
                                    <a href="https://checkinmore.com/cookies" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                        checkinmore.com/cookies
                                    </a>.
                                </p>
                                ...
                                <div className="mb-6">
                                    <h3 className="text-xl font-bold mb-3">Google API</h3>
                                    <p>
                        ...
                        <div className="mt-12" id="infouse">
                            <h2 className="text-2xl font-bold mb-4">
                                2. HOW DO WE PROCESS YOUR INFORMATION?
                            </h2>
                        ...
                        <div className="mt-12" id="legalbases">
                            <h2 className="text-2xl font-bold mb-4">
                            ...
                            <div className="mb-6">
                                ...
                                <ul className="list-disc pl-6 space-y-4">
                                    <li>
                                        <strong>Consent.</strong> We may process your information if you have given us permission (i.e., consent) to use your personal information for a specific purpose. You can withdraw your consent at any time. Learn more about <a href="#withdrawconsent" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">withdrawing your consent</a>.
                                    </li>
                            ...
                            <div className="mb-6">
                                ...
                                <p className="mb-4">
                                    We may process your information if you have given us specific permission (i.e., express consent) to use your personal information for a specific purpose, or in situations where your permission can be inferred (i.e., implied consent). You can <a href="#withdrawconsent" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">withdraw your consent</a> at any time.
                                </p>
                        ...
                        <div className="mt-12" id="whoshare">
                            <h2 className="text-2xl font-bold mb-4">
                                4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?
                            </h2>

                            <p className="mb-6">
                                <em><strong>In Short:</strong> We may share information in specific situations described in this section and/or with the following categories of third parties.</em>
                            </p>
                        ...
                        <div className="mt-12" id="cookies">
                            <h2 className="text-2xl font-bold mb-4">
                                5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?
                            </h2>
                            ...
                            <p className="mb-6">
                                ...
                                <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                        ...
                        <div className="mt-12" id="sociallogins">
                            <h2 className="text-2xl font-bold mb-4">
                                6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?
                            </h2>
                        ...
                        <div className="mt-12" id="intltransfers">
                            <h2 className="text-2xl font-bold mb-4">
                                7. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?
                            </h2>
                            ...
                            <p className="mb-4">
                                Our servers are located in the United States. If you are accessing our Services from outside the United States, please be aware that your information may be transferred to, stored by, and processed by us in our facilities and in the facilities of the third parties with whom we may share your personal information (see{" "}
                                <a href="#whoshare" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                        ...
                        <div className="mt-12" id="inforetain">
                            <h2 className="text-2xl font-bold mb-4">
                                8. HOW LONG DO WE KEEP YOUR INFORMATION?
                            </h2>
                        ...
                        <div className="mt-12" id="infosafe">
                            <h2 className="text-2xl font-bold mb-4">
                                9. HOW DO WE KEEP YOUR INFORMATION SAFE?
                            </h2>
                        ...
                        <div className="mt-12" id="infominors">
                            <h2 className="text-2xl font-bold mb-4">
                                10. DO WE COLLECT INFORMATION FROM MINORS?
                            </h2>
                        ...
                        <div className="mt-12" id="privacyrights">
                            <h2 className="text-2xl font-bold mb-4">
                                11. WHAT ARE YOUR PRIVACY RIGHTS?
                            </h2>
                            ...
                            <p className="mb-4">
                                ...
                                <a href="https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm" target="_blank" rel="noopener noreferrer" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                    Member State data protection authority
                                </a>{" "}
                                or{" "}
                                <a href="https://ico.org.uk/make-a-complaint/data-protection-complaints/data-protection-complaints/" target="_blank" rel="noopener noreferrer" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                            ...
                            <p className="mb-4">
                                ...
                                <a href="https://www.edoeb.admin.ch/edoeb/en/home.html" target="_blank" rel="noopener noreferrer" className="text-[var(--link-text)] hover:text-[var(--link-hover)]">
                                    Federal Data Protection and Information Commissioner
                                </a>.
                            </p>

                            <div id="withdrawconsent" className="mb-6">
                                <p className="mb-4">
                        ...
                        <div className="mt-12" id="uslaws">
                            ...
                            <h3 className="text-xl font-bold mb-4">What categories of personal information do we collect?</h3>
                                ...
                                <table className="min-w-full border-collapse">
                                    <thead>
                                        <tr className="border-b">
                                            ...
                                            <th className="py-2 px-4 text-left">Collected</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr className="border-b">
                                        ...
                                        <tr className="border-b">
                                            ...
                                            <td className="py-2 px-4">Account login credentials, precise geolocation</td>
                                            <td className="py-2 px-4">YES</td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <h3 className="text-xl font-bold mb-4">How do we use and share your personal information?</h3>
                            ...
                            <h3 className="text-xl font-bold mb-4">Will your information be shared with anyone else?</h3>
                            ...
                            <ul className="list-disc pl-6 mb-6 space-y-2">
                                <li>Right to know what personal information we collect, use, disclose, and sell/share</li>
                        ...
                        <div className="mt-12" id="policyupdates">
                            <h2 className="text-2xl font-bold mb-4">
                                14. DO WE MAKE UPDATES TO THIS NOTICE?
                            </h2>
                        ...
                        <div className="mt-12" id="contact">
                            ...
                            <div className="mb-6">
                                ...
                                <p>522 W Riverside Ave STE N, Spokane, WA 99201, USA</p>
                                <p>Spokane, WA 99201</p>
                                <p>United States</p>
                            </div>
                        </div>

                        <div className="mt-12" id="request">
                            <h2 className="text-2xl font-bold mb-4">
                                16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?
                            </h2>
                            ...
                            <p className="mb-6">
                                ...
                                <a
                                    href="https://checkinmore.com/data-request"
                                    className="text-[var(--link-text)] hover:text-[var(--link-hover)]"
                                >
                                    checkinmore.com/data-request
                                </a>.
