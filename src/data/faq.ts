...
export const faqs: IFAQ[] = [
    ...
    },
    {
        ...
        answer: `The app sends notifications to your selected contacts via email, text messages, or phone calls whenever a check-in status is updated. These alerts are based on the preferences you've set for each contact - so they'll only receive the updates you've chosen for them.
