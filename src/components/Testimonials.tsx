...
const Testimonials: React.FC = () => {
    return (
        <div className="flex flex-col items-center gap-10">
            <div className="grid gap-4 max-w-lg w-full mx-auto lg:grid-cols-3 lg:max-w-full">
                {testimonials.map((testimonial, index) => (
                    <div
                        key={index}
                        className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6 lg:p-7 flex flex-col gap-4 transition-transform duration-200 hover:-translate-y-1"
                    >
